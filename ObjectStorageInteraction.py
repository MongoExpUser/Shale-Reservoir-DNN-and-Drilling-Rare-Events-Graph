...
class ObjectStorageInteraction():
  ...
  """
    ...
    def object_storage_interaction_using_boto3(self, ACCESS_KEY=None, SECRET_KEY=None, REGION_NAME=None, bucket_name=None, provider=None):
        ...
        # NOTE: for BIG_DATA analytics: the "client.select_object_content()" is useful for querying CSV, JSON and PARQUET files directly
        # with simple SQL expressions on object storage, essentially turning "data-lake" into serverless database - no need to move data to DBRMS
