...
class CallPthonMLCodes
{
    ...
    invokePythonShell(pyFileName, pyVersionPath, pyScriptPath, pyMode="text")
    {
        try
        {
            ...
            //var pyArgs            = [value1, value2];                 // arguments to python script: use this if using cython
            var pyArgs              = [value3, value3, value3];         // arguments to python script: use thus if using pure python
