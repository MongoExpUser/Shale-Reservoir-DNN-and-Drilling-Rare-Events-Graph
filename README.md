...
Tensorflow.js v1.7.2 - @tensorflow/tfjs@1.7.2  (Pure JavaScript Version)

Tensorflow.js v1.7.2 - @tensorflow/tfjs-node@1.7.2  (Node.js CPU Version - with native C++ bindings)

Tensorflow.js v1.7.2 - @tensorflow/tfjs-node-gpu@1.7.2  (Node.js GPU Version - with native C++ bindings)
...
Mongoose ORM v5.9.9 (https://www.npmjs.com/package/mongoose)
