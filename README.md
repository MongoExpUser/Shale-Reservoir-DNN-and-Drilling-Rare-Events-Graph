...
Tensorflow.js v1.4.0 - @tensorflow/tfjs@1.3.2 (Pure JavaScript Version)

Tensorflow.js v1.4.0 - @tensorflow/tfjs-node@1.3.2 (Node.js CPU Version - with native C++ bindings)

Tensorflow.js v1.4.0 - @tensorflow/tfjs-node-gpu@1.3.2 (Node.js GPU Version - with native C++ bindings)
...
Mongoose ORM v5.8.0 (https://www.npmjs.com/package/mongoose)
