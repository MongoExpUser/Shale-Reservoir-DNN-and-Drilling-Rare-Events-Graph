...
Tensorflow.js v3.0.0 - @tensorflow/tfjs@3.0.0  (Pure JavaScript Version)

Tensorflow.js v3.0.0 - @tensorflow/tfjs-node@3.0.0  (Node.js CPU Version - with native C++ bindings)

Tensorflow.js v3.0.0 - @tensorflow/tfjs-node-gpu@3.0.0  (Node.js GPU Version - with native C++ bindings)
...
Mongoose ORM v5.11.15 (https://www.npmjs.com/package/mongoose)
